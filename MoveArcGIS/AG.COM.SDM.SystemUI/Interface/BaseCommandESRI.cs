...
{
    public abstract class BaseCommandESRI : ICommand
    {
        ...
        protected BaseCommandESRI()
        {
        }

        protected BaseCommandESRI(Bitmap bitmap, string caption, string category, int helpContextId, string helpFile, string message, string name, string toolTip)
        {
            m_bitmap = bitmap;
            m_name = name;
            m_message = message;
