...
{
    public partial class FrmDataOperateProgress : Form
    {
        public FrmDataOperateProgress()
        {
            InitializeComponent();
        ...
        /// 设置总进度条当前显示值
        /// </summary>
        public int SubProValue
        {
            get
            {
                return this.progressBar2.Value;
            }
            set
            {
                if (value <= progressBar2.Maximum && value >= progressBar2.Minimum)
                {
        ...
        public int SubMaxValue
        {
            get
            {
                return this.progressBar2.Maximum;
            }
            set
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static ManualResetEvent CanStopTrack(FrmDataOperateProgress FrmDataOperateProgress,
            Action action)
        {
