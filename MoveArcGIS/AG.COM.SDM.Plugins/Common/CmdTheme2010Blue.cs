...
{
    public class CmdTheme2010Blue : BaseCommand, IUseImage
    {
        private IHookHelper m_HookHelper = new HookHelper();

        public CmdTheme2010Blue()
        {
            this.m_caption = "Office 2010 蓝";
            this.m_name = GetType().Name;
            this.m_toolTip = "Office 2010 蓝";
            this.m_message = "Office 2010 蓝";
