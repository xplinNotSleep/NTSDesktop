...
{
    public class CmdThemeVS2013Dark : BaseCommand, IUseImage
    {
        private IHookHelper m_HookHelper = new HookHelper();

        public CmdThemeVS2013Dark()
        {
            this.m_caption = "Office 2013 黑";
            this.m_name = GetType().Name;
            this.m_toolTip = "Office 2013 黑";
            this.m_message = "Office 2013 黑";
