...
namespace AG.COM.SDM.Plugins.WindView
{
    ...
    public partial class AboutBox : Form
	{
        ...
        private bool m_Detailsbol = true;
		...
		{
            if (m_Detailsbol == true)
            {
                Cursor.Current = Cursors.WaitCursor;
                DetailsButton.Text = "简略";
                SuspendLayout();
                MaximizeBox = true;
                ...
                ResumeLayout();
                Cursor.Current = Cursors.Default;
                this.m_Detailsbol = false;
            }
            else
            {
                Cursor.Current = Cursors.WaitCursor;
                DetailsButton.Text = "详细";
                //SuspendLayout();
                MaximizeBox = false;
                FormBorderStyle = FormBorderStyle.FixedSingle;
                SizeGripStyle = SizeGripStyle.Hide;
                Size = new Size(400, Size.Height - 200);
                MoreRichTextBox.Visible = true;
                TabPanelDetails.Visible = false;
