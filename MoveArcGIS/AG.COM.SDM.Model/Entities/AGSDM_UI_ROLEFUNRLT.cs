...
namespace AG.COM.SDM.Model
{
    ...
    /// </summary>
    [Serializable]
    public sealed class AGSDM_UI_ROLEFUNRLT
    {
        #region 私有成员
        ...
        public string CONTROLNAME
        {
            ...
            set
            {
                ...
                m_IsChanged |= (m_CONTROLNAME != value); m_CONTROLNAME = value;
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            AGSDM_UI_ROLEFUNRLT castObj = (AGSDM_UI_ROLEFUNRLT)obj;
            return (castObj != null) &&
                (m_ID == castObj.ID);
        }
