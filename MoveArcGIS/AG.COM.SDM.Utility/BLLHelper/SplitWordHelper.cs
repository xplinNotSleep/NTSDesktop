...
namespace AG.COM.SDM.Utility
{
    ...
    public class SplitWordHelper
    {
        ...
        ///完成于：
        /// </summary> 
        public static Regex MyRegex = new Regex("^[\u4E00-\u9FA5]+$"); //汉字的正则表达式.eg: if(MyRegex.IsMatch(chrstr.ToString()))
...
"zi","zong","zou","zu","zuan","zui","zun","zuo"};
        ...
        /// <param name="CnAddSelf">把中文字符也加到输出结果</param>
        /// <returns></returns>
        public static List<List<string>> GetCnFirstSpell(string word, bool CnAddSelf)
        {
            ...
            {
                //如果是一个汉字
                if (ChineseChar.IsValidChar(charWord) == true)
                {
