...
namespace AG.COM.SDM.Utility.Display
{
    ...
    /// 新建线状对象类
    /// </summary>
    public class NewPointFeedBackEx : INewGeometryFeedBack, IDisposable,IOperation
    {
        private ISymbol m_PointSymbol = null;

        public NewPointFeedBackEx()
        {
            m_PointSymbol = new SimpleMarkerSymbolClass();
            m_PointSymbol.ROP2 = esriRasterOpCode.esriROPCopyPen;
            IRgbColor color = new RgbColorClass();
            color.Blue = 0;
            color.Green = 0;
            color.Red = 0;
            (m_PointSymbol as ISimpleMarkerSymbol).Color = color as IColor;
        ...
        public IActiveView ActiveView
        {
            ...
            set
            {
                ...
                m_PointSymbol.ResetDC();
                m_PointSymbol.SetupDC(m_HDC, m_Display.DisplayTransformation);
            }
        }
        ...
        public void Start(ESRI.ArcGIS.Geometry.IPoint point)
        {
            ...
            //(m_Point as IGeometryCollection).AddGeometry(path, ref a, ref a);
        ...
        public void AddPoint(ESRI.ArcGIS.Geometry.IPoint point)
        {
            if (m_Point == null)
                return;
            IGeometryCollection pGeoCol = m_Point as IGeometryCollection;
        ...
        private void DrawMovedPoints(IPointCollection points, IPoint point)
        {
            ...
            IPolyline line;
            m_PointSymbol.ROP2 = esriRasterOpCode.esriROPNotXOrPen;             
            m_PointSymbol.SetupDC(m_HDC, m_Display.DisplayTransformation);
            ...
            if (points.PointCount > 0)
            {
                if (m_LastPoint != null)
                {
                    ...
                    m_PointSymbol.Draw(line as IGeometry);
                }
        ...
        public ESRI.ArcGIS.Geometry.IGeometry Stop()
        {
            ...
            IGeometry pGeometry = (m_Point as ESRI.ArcGIS.esriSystem.IClone).Clone() as IGeometry;
            m_Point = null;
            m_LastPoint = null;
