...
namespace NetTopologySuite.Features.Fields
{
    ...
    public abstract class DbfField
    {
        ...
        public DbfField(string name, DbfType type, int length, int precision)
        {
        ...
        public Exception GetFieldValueError(object value, string additionalDescription = "")
        {
        ...
        public abstract void WriteValue(Stream stream);
        ...
        public static readonly IAttributesTable EmptyFieldValues = new AttributesTable();
        ...
        public static DbfField Create(string name, DbfType type)
        {
            ...
            if (type == DbfType.Numeric)
                return new DbfNumericInt32Field(name);

            if (type == DbfType.Float)
                return new DbfFloatField(name);
