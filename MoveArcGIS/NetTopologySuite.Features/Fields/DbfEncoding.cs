...
{
    public static class DbfEncoding
    {
        /// <summary>
        /// The Latin1 Encoding
        /// </summary>
        public static readonly Encoding Latin1 = Encoding.GetEncoding(28591); // ISO-8859-1
        ...
        public static void WriteMissingEncodingMessage(string encodingName)
        {
