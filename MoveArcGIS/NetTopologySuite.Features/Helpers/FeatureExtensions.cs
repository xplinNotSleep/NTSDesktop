...
namespace NetTopologySuite.Features.Helpers
{
    /// <summary>
    ...
    public static class FeatureExtensions
    {
        ...
        public static Feature ToFeature(this Geometry geometry, AttributesTable attributes)
        {
        ...
        public static AttributesTable GetAttributesTable(this DbfFieldCollection fields)
        {
            return new AttributesTable(fields.ToDictionary());
        }


        public static DbfField[] GetDbfFields(this IAttributesTable attributes)
        {
            if (attributes == null)
            {
                return null;
        ...
        public static Geometry FindNonEmptyGeometry(this IEnumerable<IFeature> features)
        {
            if (features == null)
                return null;
        ...
        private static Ordinates GetOrdinates(this Geometry geometry)
        {
            ...
            {
                return multiPoint.Geometries.FirstOrDefault().GetOrdinates();
            }
            ...
            if (geometry.NumGeometries > 0)
                return FindNonEmptyGeometry(geometry).GetOrdinates();
