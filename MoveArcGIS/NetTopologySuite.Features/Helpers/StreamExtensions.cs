...
namespace NetTopologySuite.Features.Helpers
{
    public static class StreamExtensions
    {
        ...
        {
            var bytes = ArrayPool<byte>.Shared.Rent(sizeof(ushort));
            try
            {
        ...
        public static void WriteUInt16LittleEndian(this Stream stream, ushort value)
        {
            ...
            try
            {
                ...
                stream.Write(bytes, 0, sizeof(ushort));
            }
            finally
            {
                ArrayPool<byte>.Shared.Return(bytes);
        ...
        public static void WriteUInt32LittleEndian(this Stream stream, uint value)
        {
            ...
            try
            {
                ...
                stream.Write(bytes, 0, sizeof(uint));
            }
            finally
            {
                ArrayPool<byte>.Shared.Return(bytes);
        ...
        {
            var bytes = ArrayPool<byte>.Shared.Rent(sizeof(int));
            try
            {
