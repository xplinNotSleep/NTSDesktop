...
{
    public partial class TocSceneDocument : DockDocument, ITocDocumentView
    {
        ...
        public TocSceneDocument(IFramework pFramework)
        {
            InitializeComponent();
        ...
        {
            get { return EnumDocumentType.TocSceneDocument; }
        }
